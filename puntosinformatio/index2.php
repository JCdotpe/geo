...
<head>
	...
	<script type="text/javascript">
		...
		function initialize() {
			...
			var listener1 = google.maps.event.addListener(kmlArray[0].nomkml, "metadata_changed", function() {

				google.maps.event.clearListeners(kmlArray[0].nomkml, 'metadata_changed');
				// layer.setMap(map);
			...
			<div class="row-fluid control-group span9">
				...
				<div class="controls span">
					<select id="region" class="span12" name="region">
						...
						<option value="146km0Ejf7dbByxn__oIXwdr91cDbb6G5CoIx8Tbb">LIMA</option>
					</select>
				</div>
			</div>
